	...
	static class Converter {
		...
		public static int SizeOf( ColorFormat format )
		{
			switch ( format ) {
				...
				case ColorFormat.Rg8		: return 2;
				case ColorFormat.Rg16F		: return 4;
				case ColorFormat.Rg32		: return 8;
				case ColorFormat.Rg32F		: return 8;
				...
				case ColorFormat.Rg11B10	: return 4;
		...
		public static Format Convert ( ColorFormat format )
		{
			switch ( format ) {
				...
				case ColorFormat.Rg11B10	: return Format.R11G11B10_Float;
