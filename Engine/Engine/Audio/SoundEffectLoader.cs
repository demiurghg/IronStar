...
namespace Fusion.Engine.Audio {
	...
	internal sealed class SoundEffectLoader : ContentLoader {
		...
		//	return new SoundEffect( byteArray, 0, byteArray.Length, sampleRate, (AudioChannels)channels, 0, sampleCount );
			return new SoundEffect( content.Game.SoundSystem, byteArray, 0, byteArray.Length, sampleRate, (AudioChannels)channels, 0, sampleCount );
