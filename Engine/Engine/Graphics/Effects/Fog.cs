...
namespace Fusion.Engine.Graphics {
	...
	internal partial class Fog : RenderComponent {
		...
		void SetupParameters ( Camera camera, LightSet lightSet, FogSettings settings )
		{
			...
			param.CameraMatrix				=	camera.CameraMatrix;
			...
			param.CameraTangentX			=	1;//camera.CameraTangentX;
			param.CameraTangentY			=	1;//camera.CameraTangentY;
		...
		internal void RenderFog( Camera camera, LightSet lightSet, FogSettings settings )
		{
			using ( new PixEvent("Fog") ) {
				...
				using ( new PixEvent("Lighting") ) {
					...
					device.ComputeResources[0]	=	fog3d0;
					device.ComputeConstants[0]	=	paramsCB;
					device.ComputeSamplers[0]		=	SamplerState.LinearClamp;
					device.ComputeSamplers[0]		=	SamplerState.ShadowSampler;
