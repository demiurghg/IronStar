...
namespace Fusion.Engine.Graphics.GI
{
	public partial class Radiosity
	{
		...
		static public bool SkipFiltering { get; set; } = false;
		...
		static public float SecondBounce { get; set; } = 0.5f;
		...
		static public float ShadowFilterRadius { get; set; } = 5f;

		[Config]
		[AECategory("Bilateral Filter")]
		[AEDisplayName("Weight SH L0")]
		[AESlider(0, 1, 0.1f, 0.01f)]
		static public float WeightIntensitySHL0 { get; set; } = 1f;

		[Config]
		[AECategory("Bilateral Filter")]
		[AEDisplayName("Weight SH L1")]
		[AESlider(0, 1, 0.1f, 0.01f)]
		static public float WeightDirectionSHL1 { get; set; } = 0f;
		//[Config]
		//[AECategory("Bilateral Filter")]
		//[AESlider(0,10,1f,0.01f)]
		...
		[AESlider(0, 1, 0.1f, 0.01f)]
		static public float FalloffIntensitySHL0 { get; set; } = 0.5f;

		[Config]
		[AECategory("Bilateral Filter")]
		[AEDisplayName("Falloff SH L1")]
		[AESlider(0, 1, 0.1f, 0.01f)]
		static public float FalloffDirectionSHL1 { get; set; } = 0.25f;

		[Config]
		[AECategory("Performance")]
		[AEDisplayName("Lock Region")]
		static public bool LockRegion { get; set; } = false;

		[Config]
		[AECategory("Performance")]
		[AEDisplayName("Max RPF")]
		[AESlider(0,8,1,1)]
		static public int MaxRPF { get; set; } = 1;
	}
}
