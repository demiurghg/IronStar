...
using namespace Fusion::Engine::Graphics::Scenes;
	...
	namespace Fbx {
		...
		public ref class FbxLoader {
			...
			private:
				...
				Node ^CreateSceneNode		( FbxNode *fbxNode, FbxScene *fbxScene, Fusion::Engine::Graphics::Scenes::Scene ^scene );
				...
				void GetCustomProperties	( Fusion::Engine::Graphics::Scenes::Node ^node, FbxNode *fbxNode );
