...
namespace BEPUrender.Lines
{
    ...
    /// </summary>
    public sealed class LineDrawer : IDisposable
    {
        ...
        /// </summary>
        internal DebugVertex[] vertices = new DebugVertex[16];
        ...
        public void GetNewLineIndex(out int index)
        {
            ...
            else
            {
                ...
                {
                    var resizedArray = new DebugVertex[vertices.Length * 2];
        ...
        {
            line.ColorA = new Fusion.Core.Mathematics.Color((byte)line.ColorA.R, (byte)line.ColorA.G, (byte)line.ColorA.B, (byte)0);
            line.ColorB = new Fusion.Core.Mathematics.Color((byte)line.ColorB.R, (byte)line.ColorB.G, (byte)line.ColorB.B, (byte)0);
        }
        ...
        {
            line.ColorA = new Fusion.Core.Mathematics.Color((byte)line.ColorA.R, (byte)line.ColorA.G, (byte)line.ColorA.B, (byte)255);
            line.ColorB = new Fusion.Core.Mathematics.Color((byte)line.ColorB.R, (byte)line.ColorB.G, (byte)line.ColorB.B, (byte)255);
        }
        ...
        public void Draw(DebugRender debugRender)
        {
            ...
            if (numElements > 0)
            {
				...
				{
					debugRender.PushVertex( vertices[i*2+0] );
					debugRender.PushVertex( vertices[i*2+1] );
				}
				//debugRender.PushVertex
    ...
    //            }
		...
		#warning -- no need to be disposed
        bool disposed;
        public void Dispose()
        {
            if (!disposed)
