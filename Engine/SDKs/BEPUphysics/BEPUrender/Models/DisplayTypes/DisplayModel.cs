...
namespace BEPUrender.Models
{
    ...
    public class DisplayModel : SelfDrawingModelDisplayObject
    {
        ...
        public Model Model
        {
            ...
            {
                model = value;
                transforms = new Fusion.Core.Mathematics.Matrix[model.Bones.Count];
        ...
        public Fusion.Core.Mathematics.Vector3 Color { get; set; }


        /// <summary>
        /// Gets or sets the world transformation applied to the model.
        /// </summary>
        public Fusion.Core.Mathematics.Matrix WorldTransform { get; set; }
