...
namespace IronStar.ECS
{
	...
	where T2: IComponent
	{
		...
		public abstract TResource Create ( T1 component1, T2 component2 );
		public abstract void Destroy ( TResource resource );
		public abstract void Process( TResource resource, T1 component1, T2 component2 );
	}
	...
	where T3: IComponent
	{
		...
		public abstract TResource Create ( T1 component1, T2 component2, T3 component3 );
		public abstract void Destroy ( TResource resource );
		public abstract void Process( TResource resource, T1 component1, T2 component2, T3 component3 );
	}
	...
	where T4: IComponent
	{
		...
		public void Update( GameState gs, GameTime gameTime )
		{
			...
			foreach ( var e in entities )
			{
				...
				var c4	=	e.GetComponent<T4>();
				var rc	=	resources[ e.ID ];
				Process( rc, c1,c2,c3,c4 );
			}
		}

		public abstract TResource Create ( T1 component1, T2 component2, T3 component3, T4 component4 );
		public abstract void Destroy ( TResource resource );
		public abstract void Process( TResource resource, T1 component1, T2 component2, T3 component3, T4 component4 );
	}
}
