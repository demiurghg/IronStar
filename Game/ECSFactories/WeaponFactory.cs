...
namespace IronStar.ECSFactories
{
	...
	public class WeaponMachinegunFactory : WeaponFactory
	{
		public override Entity Spawn( GameState gs )
		{
			...
			e.AddComponent( WeaponComponent.BeamWeapon( 7, 5.0f, 1, 2.0f, SpreadMode.Variable,	100,	"AMMO_BULLETS", "*trail_bullet", "bulletHit", "machinegunMuzzle" ) );
	...
	public class WeaponMachinegun2Factory : WeaponFactory
	{
		public override Entity Spawn( GameState gs )
		{
			...
			e.AddComponent( WeaponComponent.BeamWeapon( 5, 30.0f, 1, 1.0f,	SpreadMode.Variable,	100,	"AMMO_BULLETS", "*trail_bullet", "bulletHit", "machinegunMuzzle" ) );
	...
	public class WeaponPlasmagunFactory : WeaponFactory
	{
		public override Entity Spawn( GameState gs )
		{
			...
			e.AddComponent( WeaponComponent.ProjectileWeapon( 10, 150, 100, "PLASMA", "AMMO_CELLS", "plasmaMuzzle" ) );
	...
	public class WeaponRocketLauncherFactory : WeaponFactory
	{
		public override Entity Spawn( GameState gs )
		{
			...
			e.AddComponent( WeaponComponent.ProjectileWeapon( 100, 250, 750, "ROCKET", "AMMO_ROCKETS", "rocketMuzzle" ) );
	...
	public class WeaponRailgunFactory : WeaponFactory
	{
		public override Entity Spawn( GameState gs )
		{
			...
			e.AddComponent( WeaponComponent.BeamWeapon( 100, 500, 1, 0,	SpreadMode.Const,	1500,	"AMMO_SLUGS", "*trail_gauss", "railHit", "railMuzzle" ) );
