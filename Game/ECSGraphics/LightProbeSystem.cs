...
namespace IronStar.SFX2
{
	public class LightProbeSystem : ProcessingSystem<RSLightProbe,LightProbeSphere,LightProbeBox,Transform>
	{
		...
		public override RSLightProbe Create( LightProbeSphere lpSph, LightProbeBox lpBox, Transform t )
		{
			var guid = new Guid();;
			...
			Process( light, lpSph, lpBox, t );

			ls.LightProbes.Add( light );
			return new RSLightProbe();
		}

		public override void Destroy( RSLightProbe light )
		{
			ls.LightProbes.Remove( light );
		}

		
		public override void Process( RSLightProbe light, LightProbeSphere lpSph, LightProbeBox lpBox, Transform t )
		{
