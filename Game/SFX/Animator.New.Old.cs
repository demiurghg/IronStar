...
namespace IronStar.SFX {
	...
	public class Animator {
		...
		readonly Dictionary<string,AnimationTake> takes;

		int			currentFrame	=	0;
		AnimState	currentState	=	AnimState.Weapon_Idle;
		Animation	currentAnim		=	null;
		AnimationTake	currentTake		=	null;
		...
		public void Update ( Entity entity, GameTime gameTime, Matrix[] destination )
		{
			...
			currentTake.Evaluate( currentFrame + currentTake.FirstFrame, AnimationWrapMode.Clamp, destination );
